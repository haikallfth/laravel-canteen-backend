            ...
            <div class="d-flex align-items-stretch flex-wrap">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="m-3 p-4">
                        ...
                        <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">IDN Canteen</span>
                        </h4>
                        ...
                        <form method="POST"
                            ...
                            <div class="mt-5 text-center">
                                {{-- cara agar tombol create new one itu diarahkan ke bagian file register (bisa pake url atau route) --}}
